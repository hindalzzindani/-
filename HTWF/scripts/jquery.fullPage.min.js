...
!function (e) { function a(a, i) { e.isFunction(e.fn.countTo) && e(t(a, a) + " .counter").countTo({ formatter: function (e, a) { return e.toFixed(a.decimals).replace(/\B(?=(?:\d{3})+(?!\d))/g, ".") } }), e(t(a, a) + " .progress-bar").each(function () { e(this).css("width", ""); var a = this; setTimeout(function () { e(a).css("width", e(a).attr("data-progress") + "%") }, 200), e(this).attr("data-trigger", "null") }), e(t(a, a) + " .progress-circle").each(function () { e(this).progressCircle() }) } function t(a, t) { var i = "#fullpage-main .section:eq(" + (a - 1) + ")"; return e(i + " .slide").length && (i = i + " .slide:eq(" + t + ")"), i } function i(a) { e("#fullpage-horizontal-menu li").removeClass("active").removeClass("current-active"), e("#fullpage-horizontal-menu li:eq(" + a + ")").addClass("active").addClass("current-active"), e(".fullpage-arrow .arrow").css("opacity", "0").css("visibility", "hidden"), a > 0 && e(".fullpage-arrow .left").css("visibility", "visible").showAnima("fade-right"), a < g - 1 && e(".fullpage-arrow .right").css("visibility", "visible").showAnima("fade-left") } function o(a, t) { p = t, isEmpty(a) || (d = a); var i = e("#fullpage-main .section").eq(t - 1); e(".fullpage-varrow .arrow").css("opacity", "0").css("visibility", "hidden"), t < f && e(".fullpage-varrow .arrow.down").css("visibility", "visible").showAnima("fade-top"), t > 1 && e(".fullpage-varrow .arrow.up").css("visibility", "visible").showAnima("fade-bottom"), n(t, 0), g = e(i).find(".slide").length } function n(a, i) { var o = t(a, i) + " [data-fullpage-anima]"; e(o).each(function () { e(this).attr("data-anima", e(this).attr("data-fullpage-anima")), initAnima(this) }) } function l(a, i) { var o = t(a, i) + " .background-page video"; e("#fullpage-main .section .background-page video").each(function () { e(this).get(0).pause() }), e(o).length && e(o).get(0).play(); var n = e("#fullpage-main .section:eq(" + (a - 1) + ") > .background-page video"); e(n).length && e(n).get(0).play() } function s() { e(".background-page video").each(function () { var a = e(this).closest(".section"), t = e(a).width(), i = e(a).height(), o = e(this).height(), n = e(this).width(), l = n * (i / o); l / n > 1 && (e(this).css("width", Math.ceil(l) + "px"), e(this).css("margin-left", "-" + Math.floor((l - t) / 2) + "px")) }) } function r(a, t) { e(a).each(function () { var a = e(this).closest(".section"), i = parseInt(e(a).outerHeight(), 10), o = parseInt(e(this).outerHeight(), 10); o < i && e(this).css("margin-top", (i - o) / 2 + t / 2 - h + "px") }) } function c(a) { 1 == a ? (e(".scroll-hide").removeClass("hidden").animate({ opacity: 1 }, 100), e(".scroll-show").animate({ opacity: 0 }, 0, function () { e(".scroll-show").removeClass("showed") }), e(".scroll-change").removeClass("scroll-css"), e(".menu-transparent.scroll-change").addClass("bg-transparent"), b = 0) : b || (e(".scroll-hide").addClass("hidden"), e(".scroll-show").addClass("showed").animate({ opacity: 1 }, 0), e(".scroll-change").addClass("scroll-css"), e(".menu-transparent.scroll-change").removeClass("bg-transparent"), b = 1) } var u, d = 1, f = 0, g = 0, p = 0, h = 0, m = 0, v = 0, w = 0, y = !1, b = 0; e(document).ready(function () { f = e("#fullpage-main .section").length; var t = e(window).width(), g = new Array, p = "#fullpage-menu", b = e("#fullpage-main").attr("data-options"); isEmpty(b) && (b = ""); var x = !1; if ((b.indexOf("mobileMode") > -1 || t > 993) && (x = !0), v = e(window).width(), w = e(window).height(), e(".hc_fp_bottom_top_container_cnt").each(function () { e(this).find(".bottom-area").length ? e(this).closest(".section").append(e(this).html()) : e(this).closest(".section").prepend(e(this).html()), e(this).remove() }), e("#fullpage-main .fp-wp-footer").length) { var C = e("#fullpage-main .fp-wp-footer"), k = e("body footer:not(.fp-wp-footer)"); e(C).html('<div class="content">' + e(k).find(".content").html() + "</div>"), e(C).attr("class", "section fp-auto-height " + e(k).attr("class")), e(C).attr("style", e(k).attr("style")), e(k).find("> .content").remove() } h = e("#fullpage-main").attr("data-offset"), m = e("#fullpage-main").attr("data-horizonal-arrow-offset"), isEmpty(h) && (h = 0), isEmpty(m) ? m = 0 : parseInt(m, 10); var q = e("header").outerHeight(); isEmpty(q) && (q = 0), e("#fullpage-horizontal-menu").length && (p = "#fullpage-horizontal-menu", y = !0), e(p + " li:not(.scroll-show)").each(function (a) { var t; t = y ? e("#fullpage-main > .section > .slide").eq(a).attr("data-id") : e("#fullpage-main > .section").eq(a).attr("data-id"), isEmpty(t) && (t = "section-" + a), e(this).attr("data-menuanchor", t), e(this).find("a").attr("href", "#" + t), e("[data-anchor='section-" + a + "']").attr("data-anchor", t), g[a] = t }), x || (e(p).on("click", "li", function () { y ? e("#fullpage-main > .section .slide").eq(e(this).index()).scrollTo() : e("#fullpage-main > .section").eq(e(this).index()).scrollTo() }), e(p).closest("header").addClass("one-page-menu"), e("body").addClass("overflow-visble")), e("#fullpage-main").on("click", ".fullpage-inner-menu li", function () { e(this).closest(".fullpage-inner-menu"); var a = e(this).closest(".section"); e(a).find(".slide").length ? e.fn.fullpage.moveTo(e(a).index() + 1, e(this).index()) : e.fn.fullpage.moveTo(e(this).index()) }), e("#fullpage-main li:first-child").addClass("active current-active"); var T = { anchors: g, menu: p, controlArrows: !1, verticalCentered: !1, autoScrolling: x, fitToSection: x, afterSlideLoad: function (a, t, o, l) { i(l), n(t, l), "undefined" != typeof renderLoadedImgs && e.isFunction(renderLoadedImgs) && e("#fullpage-main .section .slide").eq(l - 1).renderLoadedImgs() }, afterLoad: function (a, t) { o(a, t), i(0), "undefined" != typeof renderLoadedImgs && e.isFunction(renderLoadedImgs) && e("#fullpage-main .section").eq(t - 1).renderLoadedImgs() }, afterRender: function () { u = e("header").outerHeight(), isEmpty(u) && (u = 0), e(".fullpage-menu").length && e(".fullpage-menu").css("margin-top", "-" + (e(".fullpage-menu")[0].scrollHeight - u) / 2 + "px"), y && e(".fullpage-horizontal-menu").css("margin-left", "-" + e(".fullpage-horizontal-menu").width() / 2 + "px"), e(".fullpage-varrow .up").length && e(".fullpage-varrow .up").css("margin-top", u + 25 + "px"), 0 != m && (e(".fullpage-arrow .left").length && e(".fullpage-arrow .arrow.left").css("margin-top", m + "px"), e(".fullpage-arrow .right").length && e(".fullpage-arrow .arrow.right").css("margin-top", m + "px")), e("body").on("click", "#fullpage-horizontal-menu li", function () { e.fn.fullpage.moveTo(d, e(this).index()) }), x && e("[data-fullpage-anima]:not(.section)").each(function () { var a = e(this).attr("data-trigger"); if (isEmpty(a) || "scroll" == a || "load" == a) { var t = e(this).find(".anima,*[data-anima]"); isEmpty(t) && (t = this); var i = null, o = 0; e(t).each(function () { e(this).hasClass("anima") || t == this ? (null != i && !e.contains(i, this) || null == i) && (e(this).css("opacity", 0), o++) : i = this }), 0 == o && e(this).css("opacity", 0) } }), e("body").css("overflow", "hidden"), e.isFunction(e.fn.tooltip) && e("#fullpage-menu").on("mouseout", function () { e("#fullpage-menu .tooltip").tooltip("hide") }), c(1), setTimeout(function () { u = e("header").outerHeight(), e(".fixed-top .full-width-menu").css("margin-top", +u + "px"), r(".box-middle", u) }, 300), e(".section:eq(0) .background-page video").length && e(".section:eq(0) .background-page video").get(0).play(), s(), setTimeout(function () { s() }, 2e3), i(0), e("body").on("click", ".grid-list.gallery .grid-box,.maso-list.gallery .maso-box, .lightbox,.box-lightbox", function () { e.fn.fullpage.setMouseWheelScrolling(!1) }) }, onLeave: function (t, i, o) { l(i, 0), c(i), u = e("header").outerHeight(), isEmpty(u) && (u = 0), r(".box-middle", u), e(".fullpage-menu").length && e(".fullpage-menu").css("margin-top", "-" + (e(".fullpage-menu")[0].scrollHeight - u) / 2 + "px"), e("header").css("height", u), e(".full-width-menu").css("margin-top", u - 2), a(i, 0), e("header").css("height", e("header > div:first-child").outerHeight()), e(".fullpage-varrow .arrow").removeClass("fade-top").removeClass("fade-bottom").css("opacity", "0") }, onSlideLeave: function (t, i, o, n, s) { l(i, s), a(i, s); var r = e(".section").eq(i - 1).find(".fullpage-inner-menu"); isEmpty(r) || (e(r).find("li").removeClass("current-active").removeClass("active"), e(r).find("li").eq(s).addClass("current-active").addClass("active")), e(".fullpage-arrow .arrow").removeClass("fade-left").removeClass("fade-right").css("opacity", "0") } }; if (isEmpty(b) || (b.split(","), T = getOptionsString(b, T)), x && e("#fullpage-main").fullpage(T), e("body").on("click", ".fullpage-arrow .arrow.left", function () { e(".fullpage-arrow .arrow").css("opacity", "0"), e.fn.fullpage.moveSlideLeft() }), e("body").on("click", ".fullpage-arrow .arrow.right", function () { e(".fullpage-arrow .left,.fullpage-arrow .right").css("opacity", "0"), e.fn.fullpage.moveSlideRight() }), e("body").on("click", ".fullpage-varrow .arrow.up, .scroll-content .scbox.up", function () { e(".fullpage-varrow .arrow").css("opacity", "0"), e.fn.fullpage.moveSectionUp() }), e("body").on("click", ".fullpage-varrow .arrow.down, .scroll-content .scbox.down", function () { e(".fullpage-varrow .arrow").css("opacity", "0"), e.fn.fullpage.moveSectionDown() }), e("body").on("click", ".fullpage-horizontal-menu li", function () { e(".fullpage-arrow .arrow").css("opacity", "0") }), e("body").on("click", ".fullpage-menu li", function () { e(".fullpage-varrow .arrow").css("opacity", "0") }), !x) { e("*[data-fullpage-anima]").each(function () { e(this).attr("data-anima", e(this).attr("data-fullpage-anima")) }), e(".background-page > video").each(function () { e(this).closest(".background-page").css("position", "absolutle") }), e("*[data-anima-out] .anima").css("opacity", 0); var E = 0; e(window).scroll(function () { E > 5 && (E = 0, e(".section").each(function (a) { if (isScrollView(this)) { var t = e(this).find(".background-page video"); e("#fullpage-main .section .background-page video").each(function () { e(this).get(0).pause() }), e(t).length && e(t).get(0).play() } e(window).scrollTop() < 150 && e(".section:eq(0) .background-page video").length && e(".section:eq(0) .background-page video").get(0).play() })), E += 1 }) } x && e(window).on("resize", function () { var a = e(this).height(); w != a && setTimeout(function () { location.reload() }, 500), w = a }) }) }(jQuery);